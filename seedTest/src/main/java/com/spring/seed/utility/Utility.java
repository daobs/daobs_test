package com.spring.seed.utility;
...
public class Utility {
	...
	public static String paging2(String url, int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		str.append("<div class=\"col-lg-12\" style=\"margin-top: 50px;\">");
		str.append("<nav class=\"pagination\">");
		str.append("<ul class=\"pager\" style=\"float: right\">");
		// str.append("현재 페이지: " + nowPage + " / " + totalPage + " ");

		int _nowPage = (nowGrp - 1) * pagePerBlock; // 10개 이전 페이지로 이동
		if (nowGrp >= 2) {
			str.append("<li><A href='./"+url+"?col=" + col + "&nowPage="
					+ _nowPage + "'>&lt</A></li>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				str.append("<li class=\"pagi-big\"><a href=\"#\">"+ i +"</a></li>");
//				str.append("<span class='span_box_2'>" + i + "</span>");
			} else {
				str.append("<li><A href='./"+url+"?col=" + col +  "&nowPage=" + i
						+ "'>" + i + "</A></li>");
			}
		}
