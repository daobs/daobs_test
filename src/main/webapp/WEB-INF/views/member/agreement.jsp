...
<div class="text-center">
	<img src="${root}/images/member/admin_top.png" height="15%" width="15%">
</div>
<br>
<table border="0" cellspacing="0" cellpadding="2"  align="center"> 
    <tr>  
        <td align="center"> 
            <textarea cols="130" rows="20">Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
<div style="text-align:center;font-size: 13px;font-weight: bold;">
 ...
 <div class="slider_btn" style="margin-bottom: 20px;text-align: center;">
  <a class="btn-primary" onclick="send()">동의</a>
